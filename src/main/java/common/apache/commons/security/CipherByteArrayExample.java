package common.apache.commons.security;
...
public class CipherByteArrayExample {
	...
	public static void main(String[] args) throws Exception {
		...
		final SecretKeySpec key = new SecretKeySpec(
				getUTF8Bytes("1234567890123456"), "AES");
		final IvParameterSpec iv = new IvParameterSpec(
				getUTF8Bytes("1234567890123456"));
		...
		System.out.println(Arrays.toString(Arrays.copyOf(output, updateBytes
				+ finalBytes)));
